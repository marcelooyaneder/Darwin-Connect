...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitter.setGeometry(QtCore.QRect(30, 141, 611, 71))
        self.splitter.setOrientation(QtCore.Qt.Vertical)
        self.splitter.setObjectName("splitter")
        self.xlsx_route_label = QtWidgets.QLabel(self.splitter)
        self.xlsx_route_label.setObjectName("xlsx_route_label")
        self.xlsx_route_response_label = QtWidgets.QLabel(self.splitter)
        self.xlsx_route_response_label.setText("")
        self.xlsx_route_response_label.setObjectName("xlsx_route_response_label")
        self.route_destiny_label = QtWidgets.QLabel(self.splitter)
        self.route_destiny_label.setObjectName("route_destiny_label")
        self.route_destiny_response_label = QtWidgets.QLabel(self.splitter)
