...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.darwinizer_button = QtWidgets.QPushButton(self.centralwidget)
        self.darwinizer_button.setGeometry(QtCore.QRect(20, 30, 331, 41))
        self.darwinizer_button.setObjectName("darwinizer_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.darwinizer_button.setText(_translate("MainWindow", "Darwinizer"))
